...
import {Menu, X, CircleCheck as CheckCircle2 } from "lucide-react";
  ...
  <div className="container mx-auto px-4 sm:px-6 py-12 sm:py-16 md:py-20">
    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
      ...
      <div className="flex flex-col space-y-6 sm:space-y-8 text-center md:text-left items-center md:items-start">
        <Image src="/20Years.png" alt="20 Years" width={250} height={50} className="mx-auto md:mx-0" />
      ...
      <div className="relative flex justify-center items-center">
        <div className="relative z-10">
          <Image src="/HeroImage.png" alt="Hero Image" width={500} height={400} className="w-full max-w-[500px]" />
        </div>
      </div>
    ...
    <div className="grid md:grid-cols-2 gap-8 container mx-auto">
      ...
      <div className="bg-white  rounded-2xl  border border-gray-200 overflow-hidden">
        ...
        <div className="p-8 pt-6">
          ...
          <ul className="space-y-3">
            <li className="flex items-start">
              <CheckCircle2 className="w-5 h-5 text-cyan-500 mr-3 mt-0.5" />
